...
public class DialogController extends Controller
    ...
    public static final String SAVED_DIALOG_VIEW_STATE_TAG = "android:savedDialogViewState";

    int style = STYLE_NORMAL;
    int theme = R.style.AlertDialogCustom;
    ...
    @Nullable
    public View inflateDialogView(@NonNull LayoutInflater inflater, @Nullable Bundle savedViewState) {
        return null;
    }
